package com.foucsr.learnings.mysql.database.config;
...
@EnableJpaRepositories(
		basePackages = "com.foucsr.learnings.mysql.database.repository",
...
public class MysqlDataSourceConfigLocal
{
    ...
    public LocalContainerEntityManagerFactoryBean mySqlEntityManagerFactory()
    {
        ...
        factory.setPackagesToScan(new String[]{"com.foucsr.learnings.mysql.database.model"});
